...
Изменения при этом в проект рекомендованно оформлять в отдельную ветку ии релдагать собственнику удаленного репозитория с помощью команды __**Pull request**__  